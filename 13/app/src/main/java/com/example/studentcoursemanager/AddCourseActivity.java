...
public class AddCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button primaryButton = findViewById(R.id.buttonPrimary);
        primaryButton.setText("Save Course");
        primaryButton.setOnClickListener(view -> saveCourse());
    ...
    private void saveCourse() {
        Course course = collectCourse();
        if (course == null) {
            return;
        }
        progressBar.setVisibility(View.VISIBLE);
        CourseRepository.upsertCourse(this, course);
